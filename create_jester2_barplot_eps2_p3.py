#!/usr/bin/env python3
"""
Create professional bar plot for Jester2-Swapped dataset with P=3, epsilon=2 matching the exact style
...
def load_all_data():
    ...
    data_dir = Path("jester-p-3-exp-eps2")
    all_data = []
...
def create_jester2_plot(results, algorithms):
    ...
    ax.set_title('(P = 3, ε = 2)', fontsize=30)
    ax.set_yscale('log')
...
def main():
    ...
    # Print summary
    print("\n" + "="*80)
    print("ALGORITHM PERFORMANCE SUMMARY (P=3, ε = 2)")
    print("="*80)
