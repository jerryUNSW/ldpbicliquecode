/*
 * test_p2_batch_with_ground_truth.cpp
 * 
 * Test the batch function with proper ground truth comparison for p=2
...
int main(int argc, char* argv[]) {
    ...
    // Get ground truth for all Q values (4,5,6,7,8,9,10)
