#!/usr/bin/env python3
"""
Update lrcwiki results from p3_lrcwiki_2M.txt file.
This file contains results for ALG=0 (Naive), ALG=2 (ADV), ALG=3 (ADV+), ALG=4 (ADV++).
"""
...
def update_lrcwiki_database():
    """Update the database with the new lrcwiki results"""
