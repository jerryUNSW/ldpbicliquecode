#!/usr/bin/env python3
"""
Create professional bar plot for Jester2-Swapped dataset with epsilon=2 matching the exact style
...
def load_all_data():
    ...
    data_dir = Path("jester-p-4-exp-eps2")
    all_data = []
...
def create_jester2_plot(results, algorithms):
    ...
    ax.set_title('(P = 4, ε = 2)', fontsize=30)
    ax.set_yscale('log')
...
def main():
    ...
    print("Loading experimental data from jester-p-4-exp-eps2...")
    df = load_all_data()
    ...
    # Save the plot
    output_filename = 'algorithm_comparison_jester2-swapped_eps2_FIXED_p4.pdf'
    ...
    # Print summary
    print("\n" + "="*80)
    print("ALGORITHM PERFORMANCE SUMMARY (ε = 2)")
    print("="*80)
